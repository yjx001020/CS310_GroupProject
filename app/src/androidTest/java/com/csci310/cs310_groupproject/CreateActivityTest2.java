...
public class CreateActivityTest2 {
                ...
                allOf(withId(R.id.editTextLocation),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                19)));
        appCompatEditText3.perform(scrollTo(), replaceText("25,120"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.editTextTextMultiLine),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                6)));
        appCompatEditText4.perform(scrollTo(), replaceText("csci270"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.inviteEmailEditText),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                8)));
        appCompatEditText6.perform(scrollTo(), replaceText("xxxx@usc.edu"), closeSoftKeyboard());
